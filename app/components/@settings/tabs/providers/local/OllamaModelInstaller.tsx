    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between pt-6">
        <div className="flex items-center gap-3">
          <OllamaIcon className="w-8 h-8 text-red-500" />
          <div>
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-bolt-elements-textSecondary px-1">
              ...
              <a
                ...
                className="text-red-500 hover:underline inline-flex items-center gap-1 text-base font-medium"
              >
                ollama.com/library
      ...
      <div className="grid grid-cols-1 gap-2">
        {filteredModels.map((model) => (
          ...
          >
            <OllamaIcon className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                  ...
                  {model.installedVersion && (
                    <div className="mt-0.5 flex flex-col items-end gap-0.5">
                      ...
                      {model.needsUpdate && model.latestVersion && (
                        <span className="text-xs text-red-500">v{model.latestVersion} available</span>
                      )}
                    </div>
                  )}
                </div>
