  ...
  const ModelDetails = ({ model }: { model: OllamaModel }) => (
    <div className="flex items-center gap-3 text-xs text-bolt-elements-textSecondary">
      <div className="flex items-center gap-1">
        <div className="i-ph:code text-red-500" />
        <span>{model.digest.substring(0, 7)}</span>
      </div>
      {model.details && (
        <>
          <div className="flex items-center gap-1">
            <div className="i-ph:database text-red-500" />
            <span>{model.details.parameter_size}</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="i-ph:cube text-red-500" />
                      ...
                      {editingProvider === provider.name ? (
                        ...
                        <div
                          ...
                          className={classNames(
                            ...
                            'bg-bolt-elements-background-depth-3 border border-bolt-elements-borderColor',
                            'hover:border-red-500/30 hover:bg-bolt-elements-background-depth-4',
                            'transition-all duration-200',
                          )}
                        >
              ...
              {provider.settings.enabled && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="i-ph:cube-duotone text-red-500" />
                      ...
                      <div className="text-center py-8 text-bolt-elements-textSecondary">
                        ...
                        <p className="text-sm text-bolt-elements-textTertiary px-1">
                          ...
                          <a
                            ...
                            className="text-red-500 hover:underline inline-flex items-center gap-0.5 text-base font-medium"
                          >
                            ollama.com/library
